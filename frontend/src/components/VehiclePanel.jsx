    ...
    return (
        <div>
            ...
            <div onClick={() => {
                ...
                <img className='h-10' src="https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,h_368,w_552/v1569352630/assets/4b/28f11e-c97b-495a-bac1-171ae9b29362/original/BlackSUV.png" alt="" />
                <div className='ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>UberSUV <span><i className="ri-user-3-fill"></i>6</span></h4>
                    <h5 className='font-medium text-sm'>3 mins away </h5>
                    <p className='font-normal text-xs text-gray-600'>Spacious SUV rides</p>
                </div>
            ...
            <div onClick={() => {
                ...
                <div className='ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>UberSedan <span><i className="ri-user-3-fill"></i>4</span></h4>
                    <h5 className='font-medium text-sm'>4 mins away </h5>
                    <p className='font-normal text-xs text-gray-600'>Premium sedan rides</p>
                </div>
                <h2 className='text-lg font-semibold'>₹{props.fare.sedan}</h2>
            </div>
            <div onClick={() => {
                props.setConfirmRidePanel(true)
